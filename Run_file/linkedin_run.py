...
from linkedin_unittest import *
from all_visualize import *
...
def importDataByRequestingDetailProfilePage(profiles):
	...
	for profile in profiles:
		...
		try:
			...
			print("id is", profile.urlId, Exception)
...
if __name__ == "__main__":
	...
	# print('create tables')
	# createProfileTable(db_name)
	# createEduTable(db_name)

	# print('insert basic profiles')
	# insertLinkedinProfileData(profile_list,db_name)
	# print('insert edu data')
	# insertEduData(profile_list,db_name)
